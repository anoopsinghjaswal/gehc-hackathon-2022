...
function getMessage(cb) {
  ...
  sensor.readSensorData()
    .then(function (data) {
      ...
      }), data.humidity, data.temperature_C);
    })
    .catch(function (err) {
...
function sendMessage() {
  ...
  getMessage(function (content, humidity, temperature) {
    var message = new Message(content);
    message.properties.add('humidity', humidity.toString());
    message.properties.add('temperature', temperature.toString());
